#!/bin/sh
# Fast init для VNC-варианта Chrome-контейнера.
# Запускает chromedriver + прокси как можно раньше, X11 — в фоне.
set -eu
...
# Запускаем X11 и WM в фоне (не блокируют chromedriver)
...
# Запускаем chromedriver и прокси.
